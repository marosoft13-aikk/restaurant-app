// lib/pages/full-menu.dart

import '../models/menu_item_model.dart';
import '../providers/cart_provider.dart';
import '../data/full_menu.dart';

//final menuItems = fullMenu; // أو أي اسم عندك في الملف ده
//final menuProvider = Provider.of<MenuProvider>(context);
//final items = menuProvider.menuItems;

final List<MenuItemModel> fullMenuList = [
  // 🍗 وجبات فردية
  MenuItemModel(
      id: 'meal_2pcs',
      name: 'وجبة التوفير',
...
const String settlementImagePath = 'assets/images/settlement.png';
